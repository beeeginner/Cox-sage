...
parser.add_argument("--prediction_save_path",type=str, default="prediction_output", help="The direction you want to storage risk prediction and km survival analysis")
